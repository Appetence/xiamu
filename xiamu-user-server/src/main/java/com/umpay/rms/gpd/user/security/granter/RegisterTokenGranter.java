...
public class RegisterTokenGranter extends AbstractTokenGranter {
    ...
    private Logger logger = LoggerFactory.getLogger(RegisterTokenGranter.class);
    private static final String GRANT_TYPE = "register_code";

    protected UserService userDetailsService;

    private OAuth2RequestFactory requestFactory;

    public RegisterTokenGranter(UserService userDetailsService,
