 ...
 */
@Component
public class ConsumOAuth2WebResponseExceptionTranslator implements WebResponseExceptionTranslator/*<OAuth2Exception>*/ {
        ...
        private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) throws IOException {
            ...
            ConsumOAuth2Exception exception = new ConsumOAuth2Exception(e.getMessage(), e);
