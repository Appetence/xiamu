package com.umpay.rms.gpd.user.util.rsa;
 ...
 * @description: 密码加解密
 * @author: xiamu
 * @create: 2020-07-24 01:05
 */
public class AccountSecurityUtils {

    private  static  Logger logger = LoggerFactory.getLogger(AccountSecurityUtils.class);
    ...
    public static String decrypt(String password) throws Exception {
        try {
            ...
            logger.error("password is :" + password + " 密码解密异常：" + e.getMessage());
        }
        return null;
    }
